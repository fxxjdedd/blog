...
import VFXLogoWall from "./VFXLogoWall";
        ...
        <div className="py-16 flex flex-col lg:flex-row items-center justify-center">
          <div className="w-36 h-36 rounded-full p-2 bg-blue-700 bg-opacity-80 shadow-lg">
            <div
              ...
              style={{
                backgroundImage: "url('/assets/textures/avatar.png')",
                filter:
                  "drop-shadow(0 0 2px rgba(255,255,255,0.5)) blur(0.3px)",
              }}
            ></div>
          </div>
          <div className="flex flex-col justify-center items-center lg:pl-4 lg:w-1/2">
            ...
            <div className="flex items-center space-x-4">
              <a
                href="https://github.com/fxxjdedd"
              ...
              >
                <svg
                  ...
                  stroke="white"
                  strokeWidth="0.5"
                  filter="drop-shadow(0 0 2px rgba(255,255,255,0.5)) blur(0.3px)"
                >
              ...
              <a
                href="https://twitter.com/fxxjdedd"
                className="text-black hover:text-gray-700 transition-colors duration-200"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
